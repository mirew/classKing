...
/**
 * Servlet implementation class adminReportDownServlet
 */
@WebServlet("/rbdown")
public class AdminBoardReportDownServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardReportDownServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String readFolder = request.getSession().getServletContext().getRealPath("upload/board_report_upload");
