...
<body>
	...
	<div id="cal_board" style="margin: 5px;">
		<form action="/classKing/crinsert" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="loginUser" value="<%=loginUser.getMemberId() %>">
			<table class="table table-bordered" style="border: 0;">
				...
				<tr>
					...
					<td><select name="reportCategoryNote">
							<option value="" selected="">선택</option>
							<option value="01">불법정보</option>
							<option value="02">욕설/인신공격</option>
							<option value="03">음란성/선정성</option>
